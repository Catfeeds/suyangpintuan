...
class pointprod extends Lowxp {
	function __construct() {
		$this->btnMenu = array(
			0 => array('url' => '#!pointprod/index', 'name' => '积分商品'),
			1 => array('url' => '#!pointprod/edit?com=xshow|添加积分商品', 'name' => '添加积分商品'),
		);
		parent::__construct();
	...
	function index($page = 1) {
		#检索
		$conds     = $this->getConds();
		$condition = " WHERE act_type='" . CART_CRDT . "' ";
		...
		$this->smarty->display('manage/pointprod/list.html');
	}
	...
	function edit() {
		...
		$this->smarty->display('manage/pointprod/edit.html');
	}
