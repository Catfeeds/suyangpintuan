...
class coupon extends Lowxp {
	...
	public function index($page = 1) {
		...
		$this->smarty->display('manage/coupon/list.html');
	...
	public function edit() {
		...
		$this->smarty->display('manage/coupon/edit.html');
	...
	public function editHandle($post) {
		...
		if (isset($res['error']) && $res['error'] == 0) {
			...
			$this->exeJs("parent.window.location='/manage#!coupon/index';");
		} else {
	...
	public function logs($page = 1) {
		...
		$this->smarty->display('manage/coupon/logs.html');
	}
	...
	function parseFilters($filters) {
		...
		return $tmp ? ' WHERE sid=0 AND ' . join(' AND ', $tmp) : ' WHERE sid=0 ';
	...
	public function selection($page = 1) {
		...
		$this->smarty->assign('orders', $orders);
		$this->smarty->assign('list', $list);
		$this->smarty->display('manage/coupon/selection.html');
	}
	...
	public function qrcode() {
		...
		$this->smarty->display('manage/coupon/qrcode.html');
	}
