...
$payment_lang = AppDir . 'includes/languages/payment/alipay.php';
...
class alipay {
	...
	function get_code($order, $payment) {
		...
		$button = '<div><input type="button" onclick="window.location.href=\'https://www.alipay.com/cooperate/gateway.do?' . $param . '&sign=' . md5($sign) . '&sign_type=MD5\'" class="payBtn" value="' . $GLOBALS['_LANG']['pay_button'] . '" /></div>';
