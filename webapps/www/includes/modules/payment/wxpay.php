...
<input type="button" onclick="callpay();" value="立即使用微信支付" class="enter_s1 enter_w1" />
...
EOT;
        ...
        function callpay(){
        	layer.open({
        	  ...
        	  // closeBtn: 0,
        	  area: ['222px', '264px'],
        	  content: ['/wechat/build_qrcode?data=$url', 'no'] //iframe的url
        	});
        ...
        function respond(){
            ...
            $.get("/welcome/respond/$order[log_id]", {ajax:1},

            function(data){

              if(data.is_success>0) window.location.href="/business";
        ...
        <h2>微信扫码支付</h2><br>
		<img src="/wechat/build_qrcode?data=$url" alt="">
