...
$payment_lang = AppDir . 'includes/languages/payment/kuaiqian.php';
...
class kuaiqian {
	...
	function get_code($order, $payment) {
		...
		$def_url = '<form name="kqPay" method="post" action="https://www.99bill.com/gateway/recvMerchantInfoAction.htm" target="_blank">';
		...
		$def_url .= "<input type='submit' name='submit' value='" . $GLOBALS['_LANG']['pay_button'] . "' class='payBtn' />";
