...
$payment_lang = AppDir . 'includes/languages/payment/tenpay.php';
...
class tenpay {
	...
	function get_code($order, $payment) {
		...
		if (!defined('EC_CHARSET') || ZZ_CHARSET == 'utf-8') {

			$desc = iconv("UTF-8", "GBK//IGNORE", $desc);
		...
		$button .= '<input type="button" class="payBtn" value="' . $GLOBALS['_LANG']['pay_button'] . '" /></form>';
