...
$_LANG['alipay_wap']       = '手机支付宝';
$_LANG['alipay_wap_desc']  = '手机支付宝在线支付';
$_LANG['alipay_account']   = '支付宝帐户';
$_LANG['alipay_key']       = '交易安全校验码';
$_LANG['alipay_partner']   = '合作者身份ID';
$_LANG['alipay_seller_id'] = '支付宝商户号(同合作者身份ID)';
$_LANG['pay_button']       = '立即使用支付宝支付';
$_LANG['alipay_remark']    = '商户名称';
$_LANG['alipay_cacert'] = '证书上传(cacert.pem)';
...
$_LANG['alipay_pay_method_range'][0] = '使用即时到帐交易接口';
$_LANG['alipay_pay_method_range'][1] = '使用标准双接口';
$_LANG['alipay_pay_method_range'][2] = '使用担保交易接口';
?>