...
goods.prototype={
    ...
    setStock:function(){
        ...
        if(num>0){
            ...
            var priceData,costData,stockData,serialData,priceIndex,thumbIndex,costIndex,stockIndex,serialIndex,thumbPathIndex,thumbTitleIndex;
            var spSubIds;
            ...
            this.allSpecItems.each(function(i){
                ...
                tbody+='</tr>';
                if(i==0){
                    thead+="<th>价格</th><th>成本价</th><th>库存</th><th>货号</th><th>图片上传</th></tr>";
                }
            });
